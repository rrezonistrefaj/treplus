  ...
  return (
    <Reveal as="section" className="max-w-[1260px] mx-auto px-4 sm:px-0 py-20 reveal-will-change" amount={0.2}>
      ...
      <div className="mt-13 relative ourwork-overflow">
        ...
        >
          <CarouselContent>
            {ourWorkSectionData.workItems.map((item) => (
              <CarouselItem
                key={item.id}
        ...
        <div className="mt-8 sm:hidden">
          <Button variant="custom" size="custom" className="w-full bg-[#FF5F1F] px-11.5 py-5 font-bold rounded-[10px] hover:bg-orange-600 text-white">{ourWorkSectionData.seeMoreButtonText}</Button>
        </div>
      </div>
